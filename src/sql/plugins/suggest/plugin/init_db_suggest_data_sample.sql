...
--
INSERT INTO suggest_entry (id_entry, id_suggest, id_type, title, help_message, entry_comment, mandatory, pos, default_value, height, width, max_size_enter, show_in_suggest_submit_list) VALUES (1,1,3,'Your proposal','Saisir votre proposition','',1,1,'',5,57,-1,1);


--
-- Dumping data for table `suggest_response`
--
INSERT INTO suggest_response (id_response, id_suggest_submit, response_value, id_entry) VALUES (1,1,'Add consultation statistics',1);
