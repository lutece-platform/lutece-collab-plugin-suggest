...
('DIGGLIKE_MANAGEMENT','digglike.adminFeature.digglike_management.name',2,'jsp/admin/plugins/digglike/ManageDigg.jsp','digglike.adminFeature.digglike_management.description',0,'digglike','APPLICATIONS','images/admin/skin/plugins/digglike/digglike.png',NULL);
...
INSERT INTO core_admin_role_resource (rbac_id,role_key,resource_type,resource_id,permission) VALUES 
 (908,'digg_manager','DIGGLIKE_DEFAULT_MESSAGE_TYPE','*','*');
INSERT INTO core_admin_role_resource (rbac_id,role_key,resource_type,resource_id,permission) VALUES  
 (910,'digg_manager','DIGGLIKE_EXPORT_FORMAT_TYPE','*','*');
 INSERT INTO core_admin_role_resource (rbac_id,role_key,resource_type,resource_id,permission) VALUES  
 (911,'digg_manager','DIGGLIKE_CATEGORY_TYPE','*','*');
 INSERT INTO core_admin_role_resource (rbac_id,role_key,resource_type,resource_id,permission) VALUES 
