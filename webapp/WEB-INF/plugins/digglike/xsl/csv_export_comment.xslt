...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="/digg">
		<xsl:text>"commentaire";"date du commentaire";"type de commentaire";"proposition comment&#233;e";"date proposition";"score";"nombre de vote";nombre de commentaire";"type de proposition";""cat&#233;gorie"</xsl:text>
		<xsl:text>&#10;</xsl:text>
